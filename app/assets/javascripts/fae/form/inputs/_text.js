...
Fae.form.text = {
  ...
  overrideMarkdownDefaults: function () {
    ...
    toolbarBuiltInButtons["fullscreen"].className =
      "icon-fullscreen no-disable no-mobile";
    toolbarBuiltInButtons["horizontal-rule"].className = "icon-minus";
    toolbarBuiltInButtons["preview"].className = "icon-eye no-disable";
    toolbarBuiltInButtons["side-by-side"].className =
      "icon-columns no-disable no-mobile";
